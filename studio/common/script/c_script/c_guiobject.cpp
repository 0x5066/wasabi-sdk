...
int C_GuiObject::isVisible() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), isvisible_id, NULL));
}
...
int C_GuiObject::getAlpha() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getalpha_id, NULL));
}
...
int C_GuiObject::getEnabled() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getenabled_id, NULL));
}
...
int C_GuiObject::isMouseOver(int x, int y) {
  ...
  scriptVar b = MAKE_SCRIPT_INT(y);
  scriptVar *params[2] = {&a, &b};
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), ismouseover_id, params));
}

int C_GuiObject::getLeft() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getleft_id, NULL));
}

int C_GuiObject::getTop() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), gettop_id, NULL));
}

int C_GuiObject::getWidth() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getwidth_id, NULL));
}

int C_GuiObject::getHeight() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getheight_id, NULL));
}
...
int C_GuiObject::isGoingToTarget() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), isgoingtotarget_id, NULL));
}
...
int C_GuiObject::getGuiX() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguix_id, NULL));
}

int C_GuiObject::getGuiY() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguiy_id, NULL));
}

int C_GuiObject::getGuiW() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguiw_id, NULL));
}

int C_GuiObject::getGuiH() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguih_id, NULL));
}

int C_GuiObject::getGuiRelatX() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguirelatx_id, NULL));
}

int C_GuiObject::getGuiRelatY() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguirelaty_id, NULL));
}

int C_GuiObject::getGuiRelatW() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguirelatw_id, NULL));
}

int C_GuiObject::getGuiRelatH() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getguirelath_id, NULL));
}

int C_GuiObject::isActive() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), isactive_id, NULL));
}

ScriptObject *C_GuiObject::getParent() {
  ASSERT(inited);
  return GET_SCRIPT_OBJECT(api->maki_callFunction(getScriptObject(), getparent_id, NULL));
}

ScriptObject *C_GuiObject::getParentLayout() {
  ASSERT(inited);
  return GET_SCRIPT_OBJECT(api->maki_callFunction(getScriptObject(), getparentlayout_id, NULL));
}

int C_GuiObject::runModal() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), runmodal_id, NULL));
}
...
ScriptObject *C_GuiObject::findObject(const char *id) {
  ...
  scriptVar *params[1] = {&a};
  return GET_SCRIPT_OBJECT(api->maki_callFunction(getScriptObject(), findobject_id, params));
}

const char *C_GuiObject::getName() {
  ASSERT(inited);
  return GET_SCRIPT_STRING(api->maki_callFunction(getScriptObject(), getname_id, NULL));
}
...
int C_GuiObject::clientToScreenX(int x) {
  ...
  scriptVar a = MAKE_SCRIPT_INT(x);
  scriptVar *params[1] = {&a};
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), clienttoscreenx_id, params));
}
...
int C_GuiObject::clientToScreenY(int y) {
  ...
  scriptVar a = MAKE_SCRIPT_INT(y);
  scriptVar *params[1] = {&a};
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), clienttoscreeny_id, params));
}
...
int C_GuiObject::screenToClientX(int x) {
  ...
  scriptVar a = MAKE_SCRIPT_INT(x);
  scriptVar *params[1] = {&a};
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), screentoclientx_id, params));
}
...
int C_GuiObject::screenToClientY(int y) {
  ...
  scriptVar a = MAKE_SCRIPT_INT(y);
  scriptVar *params[1] = {&a};
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), screentoclienty_id, params));
}

int C_GuiObject::getAutoWidth() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getautowidth_id, NULL));
}

int C_GuiObject::getAutoHeight() {
  ASSERT(inited);
  return GET_SCRIPT_INT(api->maki_callFunction(getScriptObject(), getautoheight_id, NULL));
}

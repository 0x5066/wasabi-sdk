...
public:
  ...
  void setDataInt(const char *name, int value, int attributes=MediaInfo::INFO_NOEDIT, int param1=0, int param2=0) { char tmp[64]; itoa(value,tmp,10); setData(name,tmp, attributes, param1, param2); }

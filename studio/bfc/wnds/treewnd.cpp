...
TreeWnd::TreeWnd() {
  ...
  autocollapse=1;
	...
	tabClosed = "studio.tree.tab.closed";
  tabOpen = "studio.tree.tab.open";
	linkTopBottom = "studio.tree.link.top.bottom";
	linkTopRight = "studio.tree.link.top.right";
	linkTopRightBottom = "studio.tree.link.top.rightBottom";
	linkTabTopBottom = "studio.tree.link.tab.top.bottom";
	linkTabTopRight = "studio.tree.link.tab.top.right";
	linkTabTopRightBottom = "studio.tree.link.tab.top.rightBottom";
}

...
int TabSheet::onAction(const char *action, const char *param, int x, int y, int p1, int p2, void *data, int datalen, RootWnd *source) {
  if (STRCASEEQL(action, "Tabsheet:NextPage")) { nextPage(); return 1; }
  if (STRCASEEQL(action, "Tabsheet:PreviousPage")) { previousPage(); return 1; }

...
#ifndef _EXAMPLEITEMSEQUENCER_H //EDITME
#define _EXAMPLEITEMSEQUENCER_H //EDITME

#include "../../studio/wac.h"

class ExampleItemSequencerWnd;

#define WACNAME WACExampleItemSequencer //EDITME

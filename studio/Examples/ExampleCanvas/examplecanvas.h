...
#ifndef _EXAMPLECANVAS_H
#define _EXAMPLECANVAS_H

//
//  This is just a header.  The useful comments and instructions are in the .cpp file
//

#include "../../studio/wac.h"

class ExampleCanvasWnd;

#define WACNAME WACExampleCanvas
...
// This is used by the window creation methods in examplecanvas.cpp
extern WACPARENT *the;

#endif//_EXAMPLECANVAS_H

...
//      File:     ExamplePopup.h
//
//!##   Purpose:  Defines the ComponentClient class for our example component
//
...
#ifndef _EXAMPLEPOPUP_H //EDITME
#define _EXAMPLEPOPUP_H //EDITME

// *** Just your average, run of the mill, clone of Example1 (with extraneous comments removed)

#include "../../studio/wac.h"

#define WACNAME WACExamplePopup //EDITME

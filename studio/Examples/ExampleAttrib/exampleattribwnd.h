...
//
#ifndef _EXAMPLEATTRIBWND_H
#define _EXAMPLEATTRIBWND_H
...
//
//  Class Definition
#define EXAMPLEATTRIBWND_PARENT StylePosWnd
class ExampleAttribWnd : public EXAMPLEATTRIBWND_PARENT {
public:
  typedef enum {
    INT,
    BOOL,
...
public:
  ...
  // How I handle attrib callbacks (and how you can, too).
  void onIntChange(int id, int value);
  void onBoolChange(int id, bool value);
  void onFloatChange(int id, double value);
  void onStringChange(int id, const char *value);
...
private:
  ...
  TextBar *myTextBar;
  SliderWnd *mySlider;
  EditWndString *myEditWnd;
};

#endif // _EXAMPLEATTRIBWND_H

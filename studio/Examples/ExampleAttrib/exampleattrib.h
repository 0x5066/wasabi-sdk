...
#ifndef _EXAMPLEATTRIB_H //EDITME
#define _EXAMPLEATTRIB_H //EDITME

// *** Just your average, run of the mill, clone of ExampleB (with extraneous comments removed)

#include "../../studio/wac.h"

class ExampleAttribWnd;

#define WACNAME WACExampleAttrib //EDITME

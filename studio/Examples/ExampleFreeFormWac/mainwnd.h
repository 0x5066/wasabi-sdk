...
#include "../../common/script/c_script/h_rootobj.h"

#define MAINWND_PARENT GuiObjectWnd

class ButtonWnd;

class MainWnd : public MAINWND_PARENT  {
  public:
    MainWnd();
    virtual ~MainWnd();
